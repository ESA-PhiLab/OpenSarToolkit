...
if os.name == 'nt':
    if Path(r'c:/Program Files/snap/bin/gpt.exe').is_file() is True:
        ...
        GPT_FILE = input(r' Please provide the full path to the'
...
config_check = dict({
    ...
    'filter': {'type': str, 'choices':
        ['None', 'Boxcar', 'Median', 'Frost', 'Gamma Map', 'Lee',
         'Refined Lee', 'Lee Sigma', 'IDAN']
               },
    ...
    'window_size': {'type': str, 'choices':
        ['5x5', '7x7', '9x9', '11x11', '13x13', '15x15', '17x17']
                    },
    ...
    'polarimetric_filter': {'type': str, 'choices':
        ['Box Car Filter', 'IDAN Filter',
         'Refined Lee Filter', 'Improved Lee Sigma Filter']
                            },
    'filter_size': {'type': int, 'choices': range(1, 100)},
    'search_window_size': {'type': int,
